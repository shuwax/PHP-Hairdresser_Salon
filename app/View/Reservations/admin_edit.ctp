				...
				<div class="table-responsive">
					...
					<div class="col-lg-8">
						...
						<fieldset>
							...
							<?php
							echo $this->Form->date('reservation_date',array('class' => 'form-control input-lg'));
							echo $this->Form->input('users_id',array('class' => 'form-control input-lg'));
							echo $this->Form->input('services_id',array('class' => 'form-control input-lg'));
							?>
						</fieldset>
