            ...
            <?php foreach($salons as $salon):?>
                        <?php if($ilosc == 0):?>
                            <div class="item active">
                                <div class="fill" style="background-image:url('/PHP-Hairdresser_Salon/img/../files/salon/filename/<?php echo $salon['Salon']['id'].'/'.$salon['Salon']['filename']?>')"></div>
                                <div class="carousel-caption">
                                    <h2><?php echo $salon['Salon']['name'];?></h2>
                                </div>
                            </div>
                        <?php endif;?>
